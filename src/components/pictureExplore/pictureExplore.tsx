      ...
      <section className="picture-explore">
        <div className="picture-explore__description">
          ...
          <p className="picture-explore__text">
            It was cleaned in 1984 to remove a <span className="picture-explore__span">"yellow veil"</span> of dust that had gathered since
        ...
        <div className="picture-explore__slider">
          <ReactCompareSlider
            position={65}
            handle={<ReactCompareSliderHandle buttonStyle={buttonStyle}></ReactCompareSliderHandle>}
            itemOne={<ReactCompareSliderImage src={before} srcSet={before}></ReactCompareSliderImage>}
            itemTwo={<ReactCompareSliderImage src={after} srcSet={after}></ReactCompareSliderImage>}
          ></ReactCompareSlider>
        </div>
      </section>
    </div>
